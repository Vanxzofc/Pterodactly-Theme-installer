  ...
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        ...
        ;;
      2)
        THEME_URL=$(echo -e "https://github.com/Vanxzofc/Pterodactly-Theme-installer/raw/main/billing.zip")
        break
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/Vanxzofc/Pterodactly-Theme-installer/raw/main/enigma.zip")
        break
        ;; 
      4)
        THEME_URL=$(echo -e "https://github.com/Vanxzofc/Pterodactly-Theme-installer/raw/main/NookTheme-theme-1.3.1-1.11.9.zip")
        break
        ;; 
      x)
        return
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer Vanz Hosting   ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Tiktok : Vanz          ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : Vanz Hosting ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by Vanz Hosting  ${NC}"
